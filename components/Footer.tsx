...
export default function Footer({ title, categories }: FooterProps) {
  return (
      <footer className="bg-black overflow-hidden">
        {/* 传递网站标题到 NewsletterTicker */}
        <NewsletterTicker title={title} />
        <div className="max-w-[95rem] mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row flex-wrap lg:justify-between gap-6 max-w-[95rem] w-full">
            <svg width="209" height="18" viewBox="0 0 209 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3.64366 17.592V11.016H9.94814V7.872H3.64366V3.528H11.1227V0.36H0V17.592H3.64366Z"
                    fill="white"></path>
              <path
              ...
              <path
                  ...
                  fill="white"></path>
              <path d="M175.494 17.592V0.36H171.85V17.592H175.494Z" fill="white"></path>
              <path
          ...
          <div
              className="flex flex-wrap flex-col md:flex-row justify-between gap-6 py-3 lg:pt-[6rem] lg:pb-[4.0625rem] w-full">
            <p className="font-regular text-white">
              由 <Link href="https://templates.gola.io/templates">Pawel Gola</Link>. 设计，由 Aman Singh Bhogal 开发。所有内容均属于各自的版权所有者。
            </p>
            <FooterSocialLinks/>
          </div>
        </div>
